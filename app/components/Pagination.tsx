...
const Pagination = ({itemCount, pageSize, currentPage}: Props) => {
    ...
    return (
        <Flex align='center' gap='2'>
            ...
            <Button color='gray' variant='soft' disabled={currentPage === 1} onClick={()=> changePage(--currentPage)}>
                <ChevronLeftIcon/>
            </Button>
            <Button color='gray' variant='soft' disabled={currentPage === pageCount} onClick={()=> changePage(++currentPage)}>
                <ChevronRightIcon/>
            </Button>
